...
def write_chart_maps(doc):
    ...
    js = ("/* AUTO-GENERATED by extract_code_map.py from code_map.json - do not edit. */\n"
...
def main():
    ...
    if os.path.exists(OCR_JSON):
        src = "Mistral-OCR annotation (hces-code/HCES-ocr-mistral/document-annotation.json)"
        print(f"Source: {src}")
        ...
        print(f"WARNING: document-annotation.json is missing - using {src}")
