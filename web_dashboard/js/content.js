...
export const INFO = {
  ...
  mpceCurve: { title: 'Spending power by group', what: 'Each line shows one group of households, from the poorest 1% to the richest 99%. The line tells you the monthly spending per person at every step. Pick a comparison from the menu: rural or urban, state, household type, social group, religion, land, cooking fuel, ration card, house type, or survey month. The percentile math is the same for every filter; only the group labels and the minimum sample size differ (household filters need 2,000+ sampled households, survey month needs 300+, state shows the 12 richest by median).', look: 'A line that starts high is a richer group. Lines that cross tell you where one group overtakes another.', source: 'Monthly consumption records (visit 1), split by household filters.' },
