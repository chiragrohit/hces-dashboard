...
export const INFO = {
  ...
  mpceDist: { title: 'Spending per person: poor to rich', what: 'This chart ranks households from poorest to richest and shows the monthly spending per person at each step. The steps are the 10th to 90th percentile. The last bar is the national average.', look: 'The richest spend many times more than the poorest.', source: 'Level 6 monthly consumption records (visit 1).' },
  mpceCurve: { title: 'Spending per person by group', what: 'Each line shows one group of households, from the 1st percentile (poorest) to the 99th (richest). At each step the line shows the monthly spending per person for that group. Pick a comparison: rural or urban, state, household type, social group, religion, land, cooking fuel, ration card, house type, or survey month. The percentile math is the same for every filter; only the group labels and the minimum sample size differ (household filters need 2,000+ sampled households, survey month needs 300+, state shows the 12 richest states/UTs by median).', look: 'A line that sits higher is a richer group. Lines that cross show where one group overtakes another.', source: 'Monthly consumption records (visit 1), split by household filters.' },
