...
export const INFO = {
  ...
  mpceDist: { title: 'Spending power: poor to rich', what: 'This chart ranks households from poorest to richest and shows the monthly spending per person at each step. The steps are the 10th to 90th percentile. The last bar is the national average.', look: 'The richest spend many times more than the poorest.', source: 'Level 6 monthly consumption records (visit 1).' },
  ...
  mpceHHType: { title: 'Spending by household type', what: 'These bars show the monthly spending per person for each household type, from casual labour to regular wage earners.', look: 'Regular wage households spend more than casual labour households.', source: 'Monthly consumption joined with household type.' },
  mpceReligion: { title: 'Spending by religion', what: 'These bars show the monthly spending per person for households of each religion.', look: 'Compare the bar heights.', source: 'Monthly consumption joined with religion of head.' },
  mpceLand: { title: 'Spending by land ownership', what: 'These bars show the monthly spending per person for households with and without land.', look: 'Households with land spend more per person.', source: 'Monthly consumption joined with land ownership.' },
  ...
  clothing: { title: 'Clothing and footwear spending', what: 'These bars show the yearly spending on clothing, bedding, and footwear. The numbers cover all of India.', look: 'Clothing is the largest of the three.', source: 'Level 13 non-food consumption records.' },
  services: { title: 'Spending on services', what: 'These bars show spending on services: education, medical care, transport, rent, and other services.', look: 'Education and medical care are the largest service costs.', source: 'Level 9-11 consumption records.' },
  fuel: { title: 'Fuel and energy spending', what: 'These bars show the money spent on fuel and energy, such as petrol, diesel, coal, and dung cake.', look: 'Petrol and diesel dominate fuel spending.', source: 'Level 8 fuel consumption records.' },
  tobacco: { title: 'Tobacco and intoxicants', what: 'These bars show spending on tobacco products and intoxicants such as liquor.', look: 'Tobacco spending is larger than intoxicants.', source: 'Level 12 consumption records.' },
...
export const PROV = {
  ...
  mpceHHType: { file: 'supplementary_consumption.parquet', cols: ['MONTHLY_CONSUMPTION_EXP', 'HOUSEHOLD_SIZE'], agg: 'income.json' },
  mpceReligion: { file: 'supplementary_consumption.parquet', cols: ['MONTHLY_CONSUMPTION_EXP', 'HOUSEHOLD_SIZE'], agg: 'income.json' },
  mpceLand: { file: 'supplementary_consumption.parquet', cols: ['MONTHLY_CONSUMPTION_EXP', 'HOUSEHOLD_SIZE'], agg: 'income.json' },
